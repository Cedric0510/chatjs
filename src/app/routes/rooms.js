...
router.post("/:id/enter", (req, res) => RoomsController.enterRoom(req, res));
router.post("/:id/leave", (req, res) => RoomsController.leaveRoom(req, res)); 
router.get("/:id/users", (req, res) => RoomsController.getRoomUsers(req, res)); 
